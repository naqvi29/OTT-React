        ...
        <Col md="12">
          <Row className=" row-cols-1 row-cols-md-2 row-cols-lg-4 mb-3 text-center">
            <Col>
              <Card className=" mb-4">
                <Card.Header className="bg-soft-primary">
                  <h5 className="card-title pricing-card-title mb-3">Free</h5>
                  <h2 className="mb-3">
                    <b>$0</b>
                    <br />
                    /Month
            ...
            <Col>
              <Card className=" mb-4 ">
                <Card.Header className="bg-soft-primary">
                  <h5 className="card-title pricing-card-title mb-3">Pro</h5>
                  <h2 className="mb-3">
                    <b>$199</b>
                    <br />
                    /Month
                ...
                <Card.Body className=" p-0">
                  <div className="table-responsive pricing pt-2">
                    <table id="my-table" className="table mb-0">
                      <thead>
                        <tr>
                          <th className="prc-wrap" style={{width: '20%'}}></th>
                          <th className="prc-wrap text-center" style={{width: '20%'}}>
                            <div
